...
$(function() {
    ...
    function handleQueue() {
        ...
        if (event !== undefined && isPlaying === false) {
            ...
            isPlaying = true;
	    if ((event.alert_image !== undefined) && (event["alert_image"].substring(0,7) == "<voice>")){
		handleTTS(event["alert_image"]);
	    }
    ...
    /*
     *@ Function handles text to speech.
     *@ Param {string} Voice Message
     */
    function handleTTS(inMessage){
	var textToSpeak = inMessage.substring(7);//Remove "<voice>"
	...
	speech.lang = 'fr-FR'; //Also added as for some reason android devices used for testing loaded spanish language 
	speech.volume = 0.70;
